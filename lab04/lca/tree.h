...
#include <vector>
#include <string>
#include <fstream> // definition of fstream <-- Used to write data to files. Creates a file if not already exists one
...
struct TreeNode{
  ...
  // Constructor
  TreeNode(int key, TreeNode *leftChild=NULL, TreeNode *rightChild=NULL, TreeNode *parent=NULL) : key(key), left(leftChild), 
                  right(rightChild), parent(parent) {}
