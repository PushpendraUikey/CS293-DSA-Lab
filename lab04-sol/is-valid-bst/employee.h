...
// outside operator overload: These functions will be invoked when this operators invoked.
// if the operator is overloaded inside the struct itself, that'd have been called instead 
// of this. In-struct operators are given priority!
...
// is the three-way comparison operator, also known as the spaceship operator. It was introduced in 
// C++20 and is used for automatic ordering of objects.
// It allows less than (<), greater than (>), equal (==), etc., to be automatically deduced.
